...
void Registry::Register(string_view name, ComponentBase* component) {
  ...
  map_[string(name)] = component;
}

void Registry::Unregister(string_view name) {
...
ComponentBase* Registry::Find(string_view name) {
